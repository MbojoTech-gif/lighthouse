...
<!----------about us content------------->
            <section class="about-us">
                <div class="row">
                    <div class="about-col">
                    <p>We preach the everlasting Gospel of christ
                        and prepare people for His second coming.We also aim
                        to be a full service Ministry sharing the love of Jesus through:<br><br>Music, Preaching and Community Outreach in
                        Schools, Prisons, Hospitals<br> and supporting persons with special needs.</p>
                        <a href="https://www.youtube.com/@lighthouseministersnrb" class="hero-btn">EXPLORE NOW</a>
                        </div>
                    <div class="about-col">
                        <img src="src/i.jpg">
                    </div>
